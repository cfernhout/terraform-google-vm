...
variable "additional_disks" {
  description = "List of maps of additional disks. See https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/compute_instance_template#auto_delete"
  type = list(object({
